...
// Duplicate of the main app's WidgetState — must remain structurally identical.
// Both modules decode the same App Group UserDefaults payload; type identity is by name.
