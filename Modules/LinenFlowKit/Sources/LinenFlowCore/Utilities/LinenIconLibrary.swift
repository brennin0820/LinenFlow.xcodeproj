...
public enum LinenIconLibrary {
    // MARK: - Items
    public static func symbolName(forItem itemName: String) -> String {
    ...
    public static func color(forItem itemName: String) -> Color {
        switch itemName {
    ...
    public static func itemSortOrder(forItem itemName: String) -> Int {
        switch itemName {
    ...
    public static func itemComesBefore(_ lhs: String, _ rhs: String) -> Bool {
    ...
    // MARK: - Towers
    public static func symbolName(forTower towerName: String) -> String {
    ...
    // MARK: - Delivery Modes
    public static var pieceDistribution: String { "number" }
    public static var bundleDelivery: String { "shippingbox.fill" }

    // MARK: - Status
    public static func symbolName(forStatus status: CalculationStatus) -> String {
        switch status {
    ...
    // MARK: - Status Color
    public static func color(forStatus status: CalculationStatus) -> Color {
        switch status {
    ...
    public enum General {
        ...
        public static let logs = "clock.arrow.circlepath"
        public static let home = "building.2"
        public static let shift = "alarm.fill"
        public static let clear = "xmark.circle.fill"
        public static let save = "tray.and.arrow.down.fill"
        public static let commandCenter = "command.circle.fill"
        public static let checklistChecked = "checkmark.circle.fill"
        public static let checklistUnchecked = "circle"
