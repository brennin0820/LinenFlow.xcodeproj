...
public enum HimmerFlowSchemaV1: VersionedSchema {
...
public enum HimmerFlowSchemaV2: VersionedSchema {
...
public enum HimmerFlowMigrationPlan: SchemaMigrationPlan {
...
public enum HimmerFlowLegacyShiftMigration {
    ...
    public static func loadOrCreateSettings(context: ModelContext) -> ShiftPlannerSettings {
