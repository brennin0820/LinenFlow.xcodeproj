...
public struct FloorEstimateResult: Equatable, Sendable {
    public let estimatedFloor: Int
    public let floorDelta: Int
    public let confidence: FloorSensingConfidence
    public let statusMessage: String
}

public enum FloorSensingEstimator {
    public static func estimateFloor(
        startFloor: Int,
    ...
    public static func nearestValidFloor(to floor: Int, in validFloors: [Int]) -> Int {
        let routeFloors = Array(Set(validFloors)).sorted()
