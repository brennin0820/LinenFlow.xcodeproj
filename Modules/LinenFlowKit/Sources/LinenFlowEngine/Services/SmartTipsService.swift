...
public final class SmartTipsService {
    ...
    public func isDismissed(_ id: SmartTipID) -> Bool {
        dismissedTipIDs.contains(id.rawValue)
    }

    public func markDismissed(_ id: SmartTipID) {
        var ids = dismissedTipIDs
        ids.insert(id.rawValue)
        saveDismissedTipIDs(ids)
    }

    public func resetDismissedTips() {
        defaults.removeObject(forKey: dismissedTipIDsKey)
    }

    public func canAutoOpen(_ id: SmartTipID, smartTipsEnabled: Bool, autoOpenEnabled: Bool) -> Bool {
    ...
    public func canPresentManually(_ id: SmartTipID, smartTipsEnabled: Bool, force: Bool) -> Bool {
...
private extension SmartTipsService {
    public static let catalog: [SmartTipID: SmartTip] = [
