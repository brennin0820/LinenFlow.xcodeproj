...
public enum TowerFloorRange {
    ...
    public static func deliveryFloors(startFloor: Int, topFloor: Int, skip13thFloor: Bool) -> [Int] {
    ...
    public static func deliveryFloorCount(startFloor: Int, topFloor: Int, skip13thFloor: Bool) -> Int {
        deliveryFloors(
    ...
    public static func isValid(startFloor: Int, topFloor: Int, skip13thFloor: Bool) -> Bool {
        deliveryFloorCount(
            startFloor: startFloor,
            topFloor: topFloor,
            skip13thFloor: skip13thFloor
    ...
    public static func summary(startFloor: Int, topFloor: Int, skip13thFloor: Bool) -> String {
    ...
    public static func formulaText(startFloor: Int, topFloor: Int, skip13thFloor: Bool) -> String {
    ...
    /// - [7] => "7"
    public static func compactFloorList(_ floors: [Int]) -> String {
