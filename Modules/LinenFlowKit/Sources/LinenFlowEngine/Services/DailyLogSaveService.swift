...
public enum SaveLogError: Error, LocalizedError, Equatable {
    case noTower
    case noEntries
...
public enum DailyLogSaveService {
    @MainActor
    public static func save(viewModel: FlowViewModel, context: ModelContext) -> Result<DailyLog, SaveLogError> {
