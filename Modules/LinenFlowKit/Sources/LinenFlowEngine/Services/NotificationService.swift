...
public final class NotificationService: NotificationServiceProtocol, @unchecked Sendable {
    ...
    public func scheduledNotificationCount() async -> Int {
        await center.pendingNotificationRequests().count
    }

    public func schedule(_ request: UNNotificationRequest) async throws {
...
public enum NotificationPlanner {
    ...
    public static let backupDelayMinutes = 10
    public static let snoozeDelayMinutes = 5
    public static let rollingSecondShiftWindowHours = 12

    public struct ShiftScheduleItem: Sendable {
    ...
    public static func rollingRequests(
    ...
    public static func shiftsEligibleForRollingSchedule(
    ...
    public static func snoozeRequest(
    ...
    public static func identifiers(withShiftPrefix shiftDate: Date, calendar: Calendar = .autoupdatingCurrent) -> (String) -> Bool {
