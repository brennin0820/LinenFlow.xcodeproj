...
public enum LiveActivityManager {
    public static func startDeliveryActivity(
        towerName: String,
        floorCount: Int,
    ...
    public static func updateDeliveryActivity(state: DeliverySessionState) {
    ...
    public static func endDeliveryActivity(state: DeliverySessionState) {
    ...
    public static func startDeliveryActivity(from state: SharedWidgetState) {
        guard ActivityAuthorizationInfo().areActivitiesEnabled else { return }
    ...
    public static func updateDeliveryActivity(from state: SharedWidgetState) {
        guard let activity = activeActivity else { return }
        Task {
            await activity.update(ActivityContent(state: contentState(from: state), staleDate: nil))
        }
    ...
    public static func endDeliveryActivity() {
        guard let activity = activeActivity else { return }
        Task {
    ...
    public static func endAllActivities() {
...
@MainActor
public enum LiveActivityManager {
    public static func startDeliveryActivity(towerName: String, floorCount: Int, towerColorHex: String?, state: DeliverySessionState) {}
    public static func updateDeliveryActivity(state: DeliverySessionState) {}
    public static func endDeliveryActivity(state: DeliverySessionState) {}
    public static func startDeliveryActivity(from state: SharedWidgetState) {}
    public static func updateDeliveryActivity(from state: SharedWidgetState) {}
