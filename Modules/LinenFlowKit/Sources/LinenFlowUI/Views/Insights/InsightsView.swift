...
public struct InsightsView: View {
    ...
    public var recommendations: [SupplyRecommendation] {
        shiftIntelligence.recommendations(logs: logs, towerFilter: towerFilter)
    }

    public struct DeliveryData: Identifiable {
        public let id = UUID()
    ...
    public struct ShortageData: Identifiable {
        public let id = UUID()
        public let date: Date
        public let item: String
        public let shortageAmount: Int
        public let unitLabel: String
    }

    public var deliveryChartData: [DeliveryData] {
    ...
    public var shortageChartData: [ShortageData] {
