...
public struct DeliveryChecklistItemPar: Identifiable, Hashable {
    public let itemName: String
    public let availableAmount: Int
    public let parAmount: Int
    public let unit: String

    public var id: String { itemName }
    public var isParMet: Bool { availableAmount >= parAmount }
}

public struct FloorChecklistView: View {
    public let floorNumbers: [Int]
    public let completedFloorNumbers: Set<Int>
    public var sensedFloorNumber: Int? = nil
    public var bundlesPerFloor: [Int: Int] = [:]
    public var itemParsByFloor: [Int: [DeliveryChecklistItemPar]] = [:]
    public let onToggleFloor: (Int) -> Void
    public var onResetCurrentPhase: () -> Void = {}
