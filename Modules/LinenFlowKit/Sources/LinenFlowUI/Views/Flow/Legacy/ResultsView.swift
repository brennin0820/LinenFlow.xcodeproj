...
private struct ResultDashboardStats {
    ...
    public let shortageCount: Int
    public let overageCount: Int
    public let enoughCount: Int
...
private struct SmartDeliveryRecommendation {
    ...
    public let rebalanceItemName: String?
}
...
private struct ResultCard: View {
    ...
    public let deliveryUnitIsBundles: Bool
    public let isPinned: Bool
    public let canPin: Bool
    public let isExpanded: Bool
    public let onToggle: () -> Void
    public let onPinToggle: () -> Void
    public let onRebalance: () -> Void
    public let onViewFloorPlan: () -> Void
