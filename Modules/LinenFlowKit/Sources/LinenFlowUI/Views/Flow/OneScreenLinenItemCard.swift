...
public enum LinenCardBackground: String, CaseIterable, Identifiable {
    case accent
    case trueBlack
    case subtle
    ...
    public var cardStyle: PremiumCardStyle {
        switch self {
...
public struct OneScreenLinenItemCard: View {
    public let item: LinenItem
    public let entry: ReceivingEntry?
    public let summary: CalculationSummary?
    public let distributionRows: [FloorDistributionRow]
    public let unitIsBundles: Bool
    public let onPiecesChange: (Int) -> Void
...
private struct StableLinenExpressionSection: View, Equatable {
    ...
    public let focusReleaseRequest: Int
    @Binding public var expression: String
    @Binding public var pieces: Int
