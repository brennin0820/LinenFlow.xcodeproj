...
public struct PropertySceneMapView: View {
    public let mappedTowers: [(tower: Tower, coordinate: CLLocationCoordinate2D)]
    public var focusTowerID: UUID?
    public var selectedTowerID: UUID?
    public var isExpanded: Bool = true
    public var isInteractive: Bool = true
    public var shouldOrbit: Bool = false
    public var onTowerSelected: ((Tower) -> Void)? = nil
