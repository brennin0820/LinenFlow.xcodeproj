...
public struct ShiftTabLegacyDeliveryArchive: View {
...
private struct ExtraLinenRow: Identifiable {
    ...
    public let extraBundles: Int
    public let loosePieces: Int
    public let extraPieces: Int
    public let shortagePieces: Int
    public let shortageBundles: Int
    public let bundleSize: Int
    public let useBundles: Bool

    public init(summary: CalculationSummary, useBundles: Bool) {
        id = summary.id
    ...
    public var primaryAvailable: Int {
        useBundles ? extraBundles : extraPieces
    }

    public var availableLoosePieces: Int {
