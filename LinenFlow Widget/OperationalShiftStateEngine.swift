...
enum CountdownUrgencyLevel: String, Codable, Hashable {
    case calm
    case warm
    case urgent
    case critical
...
enum OperationalSemanticState: String, Codable, Hashable {
...
struct OperationalShiftSnapshot: Hashable {
    let towerName: String
    let shortTowerName: String
    let floorCount: Int
    let completedFloors: Int
    let remainingFloors: Int
    let progressFraction: Double
    let currentItemNames: [String]
    let currentItemSummary: String
    let nextCarryGroupTitle: String?
    let targetTime: Date?
    let countdownText: String
    let compactCountdownText: String
    let urgencyLevel: CountdownUrgencyLevel
    let semanticState: OperationalSemanticState
...
enum OperationalShiftStateEngine {
