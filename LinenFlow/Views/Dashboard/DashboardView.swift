...
@Observable
final class ShiftDashboardViewModel {
    var orchestrator: ShiftOrchestrator?
    var now: Date = .now
    ...
    var timeline: ShiftTimelineSnapshot? {
    ...
    var heroPresentation: (label: String, time: Date) {
    ...
    func primaryCTA() -> (title: String, systemImage: String) {
        switch currentPhase {
        case .idle:
...
struct DashboardView: View {
    @Bindable var viewModel: ShiftDashboardViewModel
    var onManagePatterns: () -> Void = {}
    ...
    init(orchestrator: ShiftOrchestrator, onPrimaryAction: @escaping () -> Void) {
