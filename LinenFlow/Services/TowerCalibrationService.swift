...
enum TowerCalibrationService {
    ...
    static func estimatedFloorHeight(for tower: Tower) -> Double {
    ...
    static func floorEstimate(altitudeDeltaMeters: Double, tower: Tower) -> Int {
    ...
    static func isValidFloorMovement(altitudeDeltaMeters: Double, tower: Tower) -> Bool {
    ...
    static func floorChangeConfidence(altitudeDeltaMeters: Double, tower: Tower) -> Double {
        let height = estimatedFloorHeight(for: tower)
        guard height > 0,
