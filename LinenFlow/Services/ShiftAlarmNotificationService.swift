...
enum ShiftAlarmNotificationService {
    static let identifierPrefix = "himmerflow.shift.alarm"

    static func scheduleAlarmNotifications(
    ...
    static func cancelAlarmNotifications(identifiers: [String]) async {
        UNUserNotificationCenter.current().removePendingNotificationRequests(withIdentifiers: identifiers)
    }

    static func cancelAllShiftAlarmNotifications() {
        let center = UNUserNotificationCenter.current()
