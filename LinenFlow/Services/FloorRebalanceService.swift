...
enum FloorRebalanceError: LocalizedError, Equatable {
    case emptyItemName
...
struct FloorRebalanceService {
    func rebalanceShortFloors(_ request: FloorRebalanceRequest) throws -> FloorRebalanceResult {
