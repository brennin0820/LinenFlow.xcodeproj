...
struct FloorHeightCalibrationService: Sendable {
    ...
    func estimatedFloorDelta(verticalDeltaMeters: Double, calibration: FloorCalibrationState) -> Int? {
