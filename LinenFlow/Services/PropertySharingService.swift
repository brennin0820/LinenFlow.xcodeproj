...
enum PropertySharingError: LocalizedError {
    case invalidBase64
...
@MainActor
final class PropertySharingService {
    
    static func exportConfiguration(towers: [Tower], items: [LinenItem]) throws -> String {
    ...
    static func importConfiguration(from base64: String, context: ModelContext) throws {
